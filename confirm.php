...
if (isset($_SESSION['email'])) {
    ...
    if (isset($_POST['order'])) {
        ...
        $status = 0;
        $sql = "INSERT INTO orders( uid, hno, landmark, city, state, VehicleId, fromdate, ToDate, message, Status) VALUES (:uid,:hno,:landmark, :city, :state, :vid, :fromd, :tod, :msg, :status)";
                $query = $dbh->prepare($sql);
